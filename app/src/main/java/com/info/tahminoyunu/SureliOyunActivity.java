...
public class SureliOyunActivity extends AppCompatActivity {
    // Bağlamalar
    private TextView textViewIlBilgisi, textViewIlCevap, textViewToplamPuan, textViewSureS;
    private EditText editTextTahmin;
    private Button buttonHarfAl, buttonTahminEt, buttonTekrarOyna;
    ...
    private int alinanHarfSayisi, toplamPuan, toplamSure = 180000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewSureS = findViewById(R.id.textViewSureS);
        ...
        // 1000ms = 1 saniye
        // 60000ms = 60 saniye
        // 180000ms = 180 saniye = 3 dakika
        new CountDownTimer(toplamSure, 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                textViewSureS.setText("Kalan Süre : " + (millisUntilFinished / 60000) + " : " + ((millisUntilFinished % 60000) / 1000));
            }

            @Override
            public void onFinish() {
                textViewSureS.setText("Süre Bitti");
                buttonHarfAl.setEnabled(false);
                buttonTahminEt.setEnabled(false);
                editTextTahmin.setEnabled(false);
                Toast.makeText(getApplicationContext(), "Toplam Puan : " + toplamPuan, Toast.LENGTH_LONG).show();
    ...
    public void btnTekrarOyna(View v) {
        startActivity(new Intent(SureliOyunActivity.this, SureliOyunActivity.class));
        finish();
    }
}